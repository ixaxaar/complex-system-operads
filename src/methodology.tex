...
Composition works differently at each scale, using the same mathematical and structural blueprint - the two step process of monoidal product followed by dependency modification via stochastic kernels.
