...
\begin{scope}[shift={(6, 4)}]
    \node[above, tempcolor, font=\large] at (0, 2.2) {\textbf{$\mathcal{S}$-operad $\mathcal{W}_{\mathcal{S}}$}};
    ...
    % Hom-object notation
    \node[below, tempcolor] at (0, -2) {$\mathcal{W}_{\mathcal{S}}(I_1 \sqcup I_2, O) \in \mathbf{TempProb}$};
\end{scope}
...
\begin{scope}[shift={(2, -10)}]
    \node[above, compcolor, font=\large] at (0, 3) {\textbf{Operadic Composition in $\mathcal{W}_{\mathcal{S}}$}};
